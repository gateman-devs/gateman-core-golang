...
func (repo *MongoRepository[T]) CreateOne(ctx context.Context, payload T, opts ...*options.InsertOneOptions) (*T, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running CreateOne", logger.LoggerOptions{
			Key:  "error",
			Data: err,
...
func (repo *MongoRepository[T]) CreateBulk(payload []T, opts ...*options.InsertManyOptions) (*[]string, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running CreateBulk", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "payload",
...
func (repo *MongoRepository[T]) CreateBulkAndReturnPayload(payload []T, opts ...*options.InsertManyOptions) (*[]T, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running CreateBulkAndReturnPayload", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "payload",
...
func (repo *MongoRepository[T]) FindManyPaginated(filter map[string]interface{}, pageSize int64, lastID *string, sort int, opts ...*options.FindOptions) (*[]T, error) {
	...
	// Add cursor-based pagination filter if lastID is provided
	if lastID != nil && *lastID != "" {
		if sort == 1 {
			// Ascending: get documents after lastID
			filter["_id"] = bson.M{"$gt": *lastID}
		} else {
			// Descending: get documents before lastID
...
func (repo *MongoRepository[T]) FindManyStripped(filter map[string]interface{}, opts ...*options.FindOptions) (*[]map[string]interface{}, error) {
	...
	if err != nil {
		...
		logger.Error("mongo error occured while running FindManyStripped", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "filter",
...
func (repo *MongoRepository[T]) CountDocs(filter map[string]interface{}, opts ...*options.CountOptions) (int64, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running CountDocs", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "filter",
...
func (repo *MongoRepository[T]) FindLast(opts ...*options.FindOptions) (*T, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running FindLast", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		})
		return nil, err
...
func (repo *MongoRepository[T]) UpdateByField(filter map[string]interface{}, payload *T, opts ...*options.UpdateOptions) (bool, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running UpdateByField", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "filter",
...
func (repo *MongoRepository[T]) UpdateWithOperator(filter map[string]interface{}, payload map[string]interface{}, opts ...*options.UpdateOptions) (bool, error) {
	...
	_, err := repo.Model.UpdateOne(c, filter, payload, opts...)
	if err != nil {
		logger.Error("mongo error occured while running UpdateWithOperator", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "filter",
...
func (repo *MongoRepository[T]) UpdateManyWithOperator(filter map[string]interface{}, payload map[string]interface{}, opts ...*options.UpdateOptions) (int64, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running UpdateManyWithOperator", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "filter",
...
func (repo *MongoRepository[T]) UpdateOrCreateByField(filter map[string]interface{}, payload map[string]interface{}, opts ...*options.UpdateOptions) (bool, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running UpdateOrCreateByField", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "filter",
...
func (repo *MongoRepository[T]) UpdateOrCreateByFieldAndReturn(filter map[string]interface{}, payload T, opts ...*options.UpdateOptions) (*string, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running UpdateOrCreateByFieldAndReturn", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "filter",
...
func (repo *MongoRepository[T]) UpdateByID(id string, payload *T, opts ...*options.UpdateOptions) (bool, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running UpdateByID", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "resourceID",
...
func (repo *MongoRepository[T]) UpdatePartialByID(id string, payload interface{}, opts ...*options.UpdateOptions) (int64, error) {
	...
	if err != nil {
		logger.Error("mongo error occured while running UpdatePartialByID", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		}, logger.LoggerOptions{
			Key:  "resourceID",
...
func (repo MongoRepository[T]) StartTransaction(payload func(sc mongo.Session, c context.Context) error) error {
	...
	if err := payload(session, ctx); err != nil {
		logger.Error("mongo error occured while running StartTransaction", logger.LoggerOptions{
			Key:  "error",
			Data: err,
		})
		return err
